...
public class Addition {
    ...
    public static ArrayList getNumbers() {
        ...
        while (true) {
            ...
            if (counter < 3) {
                ...
                System.out.println("Enter a number you want to add. Or enter \"Exit\" to see the sum of the numbers you've entered.");
    ...
    public static double addSum(ArrayList<Double> numbers) {
        double sum = 0;
     ...
     public static void returnSum(double sum) {
