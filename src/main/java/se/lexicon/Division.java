...
public class Division {
    public static ArrayList getNumbers() {
        ...
        while (true) {
            ...
            if (counter < 3) {
                ...
                System.out.println("Enter a number you want to divide. Or enter \"Exit\" to see the quotient of the numbers you've entered.");
    ...
    public static double divideQuotient(ArrayList<Double> numbers) {
        double quotient = 0;
        int counter = 0;
    ...
    public static void returnQuotient(double quotient) {
        System.out.println("Here is the difference of your numbers: " + quotient);
    }
}